...
public class Corrente extends Conta{
	...
	public static void transferencia(int indice) {
		System.out.println("--- MENU TRANSFER�NCIA ---"
				+ "\n1- Corrente"
				+ "\n2Poupan�a");
		int opcao = tec.nextInt();
		
		System.out.println("Informe o valor da transfer�ncia: R$");
		double transferencia = tec.nextDouble();
		
		System.out.print("Informe o n�mero da conta que ser� transferido o dinheiro: ");
